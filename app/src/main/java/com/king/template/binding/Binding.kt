...
@BindingAdapter(value = ["netImg","defaultImg"], requireAll = false)
fun setBackground (imageView: ImageView,imageUrl: String?,resId: Int){
    GlideApp.with(imageView.context).load(imageUrl).placeholder(resId).into(imageView)
}
